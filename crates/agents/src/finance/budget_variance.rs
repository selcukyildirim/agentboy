...
impl Agent for BudgetVarianceAgent {
    fn manifest(&self) -> AgentManifest {
        AgentManifest {
            ...
            max_cost_usd: None,
            input_schema: vec![
                InputField::new("budget", "Budget", InputKind::File, true),
                InputField::new("actual", "Actuals", InputKind::File, true),
                InputField::new("threshold", "Threshold", InputKind::Number, true).with_example("10"),
            ],
        }
    }
