...
impl Agent for BankReconciliationAgent {
    fn manifest(&self) -> AgentManifest {
        AgentManifest {
            ...
            max_cost_usd: None,
            input_schema: vec![
                InputField::new("bank_statement", "Bank Statement", InputKind::File, true).with_example("date,amount,reference\n2024-01-01,100.00,REF1\n2024-01-02,200.00,REF2"),
                InputField::new("ledger", "Ledger", InputKind::File, true).with_example("date,amount,reference\n2024-01-01,100.00,REF1\n2024-01-04,300.00,REF4"),
                InputField::new("tolerance", "Tolerance", InputKind::Number, true).with_example("0.01"),
            ],
        }
    }
